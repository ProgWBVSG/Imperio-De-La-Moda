          ...
          <div className="flex-1 space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-border p-4 md:p-6 overflow-hidden">
              ...
              <div className="divide-y divide-border">
                {items.map((item) => (
                  <div key={item.id} className="py-4 md:py-6 flex flex-col md:grid md:grid-cols-12 gap-4 items-center relative group">
                    ...
                    <div className="hidden md:flex absolute right-0 top-1/2 -translate-y-1/2 mr-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button onClick={() => quitarItem(item.id)} className="text-red-500 hover:text-red-700 bg-red-50 hover:bg-red-100 p-2 rounded-full transition-colors shadow-sm" title="Eliminar producto">
