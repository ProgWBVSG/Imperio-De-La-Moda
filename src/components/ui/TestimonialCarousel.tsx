    ...
    <div className="relative">
          ...
          {testimonios.map((t) => (
            ...
            >
              <div className="bg-white p-8 rounded-2xl shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-border relative h-full flex flex-col justify-between hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.1)] transition-all duration-300">
                ...
                <p className="text-gray-700 italic mb-6 leading-relaxed text-sm flex-grow">"{t.texto}"</p>
      ...
      <div className="flex justify-center gap-4 mt-8">
        <button
          onClick={scrollPrev}
          aria-label="Anterior"
          className="w-12 h-12 rounded-full border-2 border-primary text-primary flex items-center justify-center hover:bg-primary hover:text-white transition-all duration-200 active:scale-95"
        >
