...
// API para buscar Data del producto
async function getProduct(slug: string) {
  // Como estamos en un Server Component, llamamos a la API local
  // En producción deberíamos usar db query directo, pero para este boilerplate usamos fetch
  const res = await fetch(`http://localhost:3000/api/productos/${slug}`, { cache: 'no-store' });
